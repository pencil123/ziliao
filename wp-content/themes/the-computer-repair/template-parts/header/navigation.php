...
<div id="header" class="menubar">
    ...
    <div class="toggle-nav mobile-menu">
      <button role="tab" onclick="the_computer_repair_menu_open_nav()"><i class="<?php echo esc_attr(get_theme_mod('the_computer_repair_res_open_menu_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','the-computer-repair'); ?></span></button>
    </div>

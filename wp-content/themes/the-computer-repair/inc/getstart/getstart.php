...
function the_computer_repair_admin_theme_style() {
   ...
   wp_enqueue_style('the-computer-repair-custom-admin-style', get_template_directory_uri() . '/inc/getstart/getstart.css');
   wp_enqueue_script('the-computer-repair-tabs', get_template_directory_uri() . '/inc/getstart/js/tab.js');
}
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="the_computer_repair_open_tab(event, 'computer_lite')"><?php esc_html_e( 'Getting Started', 'the-computer-repair' ); ?></button>		  

...
class The_Computer_Repair_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $the_computer_repair_font_awesome_icon_array = the_computer_repair_font_awesome_icon_array();
                    foreach ($the_computer_repair_font_awesome_icon_array as $the_computer_repair_font_awesome_icon) {
                            $icon_class = $this->value() == $the_computer_repair_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($the_computer_repair_font_awesome_icon).'"></i>
                            <span class="the-computer-repair-social-class">'.esc_attr($the_computer_repair_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function the_computer_repair_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'the-computer-repair-customizer-script', get_template_directory_uri().'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'the_computer_repair_customizer_script' );

if(!function_exists('the_computer_repair_font_awesome_icon_array')){
    function the_computer_repair_font_awesome_icon_array(){

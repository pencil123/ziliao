...
class The_Computer_Repair_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'The_Computer_Repair_About_Widget',
			__('VW About us', 'the-computer-repair'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'the-computer-repair' ), ) 
		);
	}
	...
	public function form( $instance ) {
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','the-computer-repair'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','the-computer-repair'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','the-computer-repair'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','the-computer-repair'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','the-computer-repair'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','the-computer-repair'); ?></label>
		<?php
...
function the_computer_repair_about_custom_load_widget() {
	register_widget( 'The_Computer_Repair_About_Widget' );
}
add_action( 'widgets_init', 'the_computer_repair_about_custom_load_widget' );
...
function the_computer_repair_customize_preview_js() {
	wp_enqueue_script( 'the-computer-repair-customizer', get_template_directory_uri() . '/inc/logo/js/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function the_computer_repair_customize_controls_js() {
	wp_enqueue_script( 'the-computer-repair-customizer-controls', get_template_directory_uri() . '/inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
